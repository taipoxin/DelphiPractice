{Задача 4.
Написать рекурсивную программу вычисления суммы членов геометрической прогрессии, начиная с
i-го по k-тый элемент
}
//формула суммы n первых членов геометрической прогресии
//первый член + второй член + ....
//найти с сумму c i по К член
unit Unit1;
...
begin
  ...
  if (i > 0) and (k > 0) then
    ...
    ShowMessage('I,K должны быть бльше 1');
